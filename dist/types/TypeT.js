...
(function() {
  ...
  module.exports = function(Module) {
    ...
    return Module.defineType(IrreducibleG('TypeT', function(x) {
      var ref;
      return _.isFunction(x) && _.isPlainObject(x.meta) && ((ref = x.meta.kind) !== 'generic' && ref !== 'class' && ref !== 'module' && ref !== 'mixin');
    }));
  };
