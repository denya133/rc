...
(function() {
  ...
  module.exports = function(Module) {
    var FunctionT, NON, SubtypeG;
    ({NON, SubtypeG, FunctionT} = Module.prototype);
    return Module.defineType(SubtypeG(FunctionT, 'AsyncFunctionT', function(x) {
      // NOTE: только функции созданные через co.wrap пока что являются асинковыми
      return x.__generatorFunction__ != null;
    }, NON));
  };
